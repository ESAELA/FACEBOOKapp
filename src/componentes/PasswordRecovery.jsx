function PasswordRecovery () {
    return (
        <div>
            ...
            <nav className="bg-white flex justify-between h-[60px] shadow-lg ">
                    <img 
                ...
                <div className="flex justify-end items-center gap-2 mr-7">
                    ...
                    <a id="IniciarSessao" className="flex justify-center items-center cursor-pointer w-[130px] rounded-md h-10 text-white font-bold ">Iniciar sessão</a>
